...
<aside id="layout-menu" class="layout-menu menu-vertical menu" data-bs-theme="dark">
  ...
  <span class="text-primary">
    ...
    <svg width="25" viewBox="0 0 25 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
      ...
      <span class="app-brand-text demo menu-text fw-bold ms-2">Kelly Project</span>
    </a>
  ...
  <ul class="menu-inner py-1 text-white">
    ...
    @foreach (menusByRole() as $group => $menus)
          <!-- Settings -->
      <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          <i class="menu-icon tf-icons bx bx-cog"></i>
          <div class="text-truncate" data-i18n="Settings">{{ $group }}</div>
        </a>
        <ul class="menu-sub">
          @foreach ($menus as $menu)
            <li class="menu-item">

              <a href="{{ $menu->vc_url }}" class="menu-link">  
                  <div data-i18n="{{ $menu->vc_nome }}">{{ $menu->vc_nome }}</div>
              </a>
            </li>            
          @endforeach
        </ul>
            ...
            <li>
              <a class="dropdown-item" href="pages-account-settings-account.html">
                <div class="d-flex">
                  <div class="flex-shrink-0 me-3">
                    <div class="avatar avatar-online">
                      <img src="{{ isset(Auth::user()->profile_photo_path)?asset(Auth::user()->profile_photo_path):'../../assets/img/avatars/1.png' }}" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </div>
                  <div class="flex-grow-1">
                    <h6 class="mb-0">{{ Auth::user()->name }}</h6>
                    <small class="text-body-secondary">{{ Auth::user()->fk_role->vc_nome }}</small>
                  </div>
                </div>
              </a>
            </li>
            ...
            <li>
                <form action="{{ route('logout') }}" method="POST">
                  @csrf
                    ...
                    this.closest('form').submit();"><i class="fa fa-power-off m-r-5 m-l-5"></i>Terminar Sessão</a>
                </form>
          </ul>
        </li>
        <!--/ User -->
