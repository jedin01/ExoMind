                ...
                <div class="card ">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h4 class="mb-1">Treinamentos</h4>
                                <p class="mb-0 opacity-75">Gerencie todos os registros de treinamento</p>
                            </div>
                            ...
                            @if ($adicionar)
                                <button 
                                    ...
                                    data-bs-target="#addTreinamentoModal"
                                >
                                        ...
                                        <td class="text-center">
                                            ...
                                            <td>
                                                    <div class="dropdown">
                                                        ...
                                                        >
{{ $item->dt_data ? $item->dt_data->format('d/m/Y') : 'N/A' }}                                                        </button>
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <span class="dropdown-item-text">
                                                                    <strong>Data Completa:</strong><br>
{{ $item->dt_data ? $item->dt_data->format('d/m/Y') : 'N/A' }}                                                                </span>
                                                            </li>
                                                        </ul>
                                                    </div>
                                            </td>
                                            <td>
                                                    <span class="fw-medium">{{ $item->hora_inicio }}</span>
                                            </td>
                                            <td>
                                                    <span class="fw-medium">{{ $item->hora_termino }}</span>
                                            </td>
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a 
                                                            href="{{ route('admin.treinamento.show', ['id' => $item->id]) }}" 
                                                            class="dropdown-item"
                                                        >
                                                    ...
                                                    @if ($editar)
                                                        <li>
                                                            <a 
                                                                ...
                                                                class="dropdown-item" 
                                                                data-bs-toggle="modal" 
                                                                data-bs-target="#editTreinamentoModal--{{ $item->id }}"
                                                            >
                                                    ...
                                                    @if ($remover)
                                                        ...
                                                        <li>
                                                            <a 
                                                                href="#" 
                                                                data-url="{{ route('admin.treinamento.destroy', ['id' => $item->id]) }}" 
                                    ...
                                    @if ($editar)
                                        <div class="modal fade" id="editTreinamentoModal--{{ $item->id }}" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form 
                                                            method="post" 
                                                            action="{{ route('admin.treinamento.update', ['id' => $item->id]) }}" 
                                                            class="row g-3" 
                                    ...
                                    <tr>
                                        <td colspan="6" class="text-center py-5">
                                            <div class="d-flex flex-column align-items-center">
                                                ...
                                                <p class="text-muted mb-0">Não há treinamento cadastrados no momento.</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
        ...
        <!-- Modal de Adição -->
        @if ($adicionar)
            <div class="modal fade" id="addTreinamentoModal" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Adicionar Novo Treinamento</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        ...
                        <div class="modal-body">
                            <form 
                                class="row g-3" 
                                action="{{ route('admin.treinamento.store') }}" 
                                method="post" 
                                enctype="multipart/form-data"
                            >
                                @csrf
