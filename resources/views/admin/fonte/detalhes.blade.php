...
@section('titulo', 'Detalhes do Fonte')
    ...
    <div class="col-xl-8 col-lg-7 order-0 order-md-1">
      ...
      <div class="bs-stepper wizard-numbered mt-2">
        <div class="bs-stepper-header" style="overflow-x: scroll;">
          <div class="step" data-target="#dataset">
        ...
        <div class="bs-stepper-content">
          <div class="card mb-6 content" id="dataset">
            @include('admin.dataset.data',[
              'items' => $item->fk_dataset,
              'fonte_detail' => $item,
              'title' => "Gestão de Dataset",
              'subtitle' => "Dataset",
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered modal-simple">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <form method="post" enctype="multipart/form-data" action="{{route('admin.fonte.update',['id' => $item->id])}}" class="row">
          @csrf
