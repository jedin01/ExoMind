          ...
          <div class="info-container">
            <ul class="list-unstyled mb-6">
              <li class="mb-2">
                ...
                <span>{{ $item->vc_email }}</span>
              </li>
              <li class="mb-2">
                <span class="h6">Password: </span>
                <span>{{ $item->vc_password }}</span>
              </li>
              <li class="mb-2">
                <span class="h6">Profile_photo_path: </span>
                <span>{{ $item->vc_profile_photo_path }}</span>
              </li>
              <li class="mb-2">
                <span class="h6">Role:</span>
                <span>{{ isset($item->fk_role) ? $item->fk_role->nome_registro : '' }}</span>
              </li>
            </ul>
    ...
    <div class="col-xl-8 col-lg-7 order-0 order-md-1">
      ...
      <div class="bs-stepper wizard-numbered mt-2">
        <div class="bs-stepper-header" style="overflow-x: scroll;">
          <div class="step" data-target="#log">
            <button type="button" class="step-trigger">
              <span class="bs-stepper-circle">2</span>
              <span class="bs-stepper-label">
                <span class="bs-stepper-title">Log</span>
              </span>
            </button>
          </div>
        </div>
        <div class="bs-stepper-content">
          <div class="card mb-6 content" id="log">
            @include('admin.log.data',[
              'items' => $item->fk_log,
              'user_detail' => $item,
              'title' => "Gestão de Log",
              'subtitle' => "Log",
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered modal-simple">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <form method="post" enctype="multipart/form-data" action="{{route('admin.user.update',['id' => $item->id])}}" class="row">
          @csrf
