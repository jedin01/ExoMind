...
@section('titulo', 'Pre de Processamentos')
...
@section('conteudo')
    <!-- Pre de Processamentos Table -->
    <div class="card">
        <div class="card-datatable table-responsive">
            <div class="d-flex justify-content-between p-4 align-items-center mb-3">
                <h4 class="mb-0">Gerenciamento de Pre de Processamentos</h4>
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addModal">
                    <i class="bx bx-plus me-1"></i>
                </button>
                <a class="btn btn-primary" href="{{ route('admin.pre_processamento.trashed') }}">
                ...
                <tbody>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <li>
                                            <a href="{{ route('admin.pre_processamento.show', ['id' => $item->id]) }}" class="dropdown-item">
                                                <i class="bx bx-show me-1"></i> Ver Detalhes
                                            </a>
                                        </li>

                                        <li>
                                            <a href="{{ route('admin.pre_processamento.treinamento_pre_processamento', ['id' => $item->id]) }}" class="dropdown-item">
                                                <i class="bx bx-show me-1"></i> Treinamentopreprocessamentos
                                            </a>
                                        </li>

                                        <li>
                                            <a href="#" data-url="{{ route('admin.pre_processamento.destroy', ['id' => $item->id]) }}" class="removeItem dropdown-item">
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered modal-simple">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            ...
                                            <form class="row" method="post" action="{{ route('admin.pre_processamento.update', ['id' => $item->id]) }}" class="row" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row">
                    ...
                    @empty
                        <tr>
                            ...
                            <td colspan="3" class="text-center">Nenhum pre_processamentos encontrado.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-simple">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <form class="row" action="{{ route('admin.pre_processamento.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @php
                            $item = null;
                        @endphp
