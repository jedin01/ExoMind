<div class="container-fluid">
                ...
                <div class="card ">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h4 class="mb-1">Pre de Processamentos</h4>
                                <p class="mb-0 opacity-75">Gerencie todos os registros de preprocessamentos</p>
                            </div>
                            ...
                            @if ($adicionar)
                                <button 
                                    ...
                                    data-bs-target="#addPreProcessamentosModal"
                                >
                                    <i class="bx bx-plus me-1"></i>
                                    Adicionar PreProcessamentos
                                </button>
                            @endif
                        </div>
                    </div>
                ...
                <div class="card shadow-sm">
                    <div class="card-header border-bottom">
                        <h5 class="card-title mb-0">
                            ...
                            Lista de Pre de Processamentos
                        </h5>
                    </div>
                    
                    <div class="card-datatable table-responsive">
                        <table class="datatables-pre_processamentos table">
                          <thead class="border-top">
                            ...
                            <tbody>
                                @forelse($items as $item)
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a 
                                                            href="{{ route('admin.pre_processamentos.show', ['id' => $item->id]) }}" 
                                                            class="dropdown-item"
                                                        >
                                                    ...
                                                    @if ($editar)
                                                        <li>
                                                            <a 
                                                                ...
                                                                class="dropdown-item" 
                                                                data-bs-toggle="modal" 
                                                                data-bs-target="#editPreProcessamentosModal--{{ $item->id }}"
                                                            >
                                                    ...
                                                    @if ($remover)
                                                        ...
                                                        <li>
                                                            <a 
                                                                href="#" 
                                                                data-url="{{ route('admin.pre_processamentos.destroy', ['id' => $item->id]) }}" 
                                    ...
                                    @if ($editar)
                                        <div class="modal fade" id="editPreProcessamentosModal--{{ $item->id }}" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Editar PreProcessamentos</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form 
                                                            method="post" 
                                                            action="{{ route('admin.pre_processamentos.update', ['id' => $item->id]) }}" 
                                                            class="row g-3" 
                                                        ...
                                                        >
                                                            ...
                                                            @include('forms.pre_processamentos.index')
                                    ...
                                    <tr>
                                        <td colspan="3" class="text-center py-5">
                                            <div class="d-flex flex-column align-items-center">
                                                ...
                                                <p class="text-muted mb-0">Não há preprocessamentos cadastrados no momento.</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
        ...
        <!-- Modal de Adição -->
        @if ($adicionar)
            <div class="modal fade" id="addPreProcessamentosModal" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Adicionar Novo PreProcessamentos</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        ...
                        <div class="modal-body">
                            <form 
                                class="row g-3" 
                                action="{{ route('admin.pre_processamentos.store') }}" 
                                method="post" 
                                enctype="multipart/form-data"
                            >
                                @csrf
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            $('.datatables-pre_processamentos').DataTable({
                responsive: {
                    details: {
                        type: 'column',
                        target: 'tr'
