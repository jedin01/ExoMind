...
@section('titulo', 'Detalhes do PreProcessamentos')
...
<div class="row">
    ...
    <div class="col-xl-8 col-lg-7 order-0 order-md-1">
      <!-- User Pills -->
      @php
        $pre_processamentos_detail = $item;
      @endphp
...
<!-- Edit  Modal -->
@php
  $item = $pre_processamentos_detail;
@endphp
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered modal-simple">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <form method="post" enctype="multipart/form-data" action="{{route('admin.pre_processamento.update',['id' => $item->id])}}" class="row">
          @csrf
