    ...
    <div class="card">
        <div class="card-datatable table-responsive">
            <div class="d-flex justify-content-between p-4 align-items-center mb-3">
                <h4 class="mb-0">Gerenciamento de Modules</h4>
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addModal">
                    <i class="bx bx-plus me-1"></i>
                </button>
                <a class="btn btn-primary" href="{{ route('admin.module.trashed') }}">
                    <i class="bx bx-trash me-1"></i>
                </a>
            </div>
            <table class="datatables-module table">
                ...
                <tbody>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <li>
                                            <a href="{{ route('admin.module.show', ['id' => $item->id]) }}" class="dropdown-item">
                                                <i class="bx bx-show me-1"></i> Ver Detalhes
                                            </a>
                                        </li>

                                        <li>
                                            <a href="{{ route('admin.module.role_permissions', ['id' => $item->id]) }}" class="dropdown-item">
                                                <i class="bx bx-show me-1"></i> Rolepermissionss
                                            </a>
                                        </li>

                                        <li>
                                            <a href="#" data-url="{{ route('admin.module.destroy', ['id' => $item->id]) }}" class="removeItem dropdown-item">
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered modal-simple">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            ...
                                            <form class="row" method="post" action="{{ route('admin.module.update', ['id' => $item->id]) }}" class="row" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row">
                                                    @include('forms.module.index')
                                                </div>
                    ...
                    @empty
                        <tr>
                            ...
                            <td colspan="9" class="text-center">Nenhum module encontrado.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-simple">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <form class="row" action="{{ route('admin.module.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @php
                            $item = null;
                        @endphp
