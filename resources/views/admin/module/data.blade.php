                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <p class="mb-0 opacity-75">Gerencie todos os registros de module</p>
                            </div>
                                ...
                                @forelse($items as $item)
                                    <tr>
                                        <td class="text-center">
                                            ...
                                            <td>
                                                    <span class="fw-medium">{{ $item->vc_prefix }}</span>
                                            </td>
                                            <td>
                                                    <span class="fw-medium">{{ $item->vc_route_subgroup }}</span>
                                            </td>
                                            <td>
                                                    <span class="fw-medium">{{ $item->vc_url }}</span>
                                            </td>
                                            <td>
                                                    <span class="fw-medium">{{ $item->vc_sub_group }}</span>
                                            </td>
                                            <td>
                                                    <span class="fw-medium">{{ $item->vc_icon }}</span>
                                            </td>
                                        
                                            <td>
                                                <span class="text-primary fw-medium">
{{ $item->fk_group->nome ?? 'N/A' }}                                                </span>
                                            </td>
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a 
                                                            href="{{ route('admin.module.show', ['id' => $item->id]) }}" 
                                                            class="dropdown-item"
                                                        >
                                                    ...
                                                    @if ($editar)
                                                        <li>
                                                            <a 
                                                                ...
                                                                class="dropdown-item" 
                                                                data-bs-toggle="modal" 
                                                                data-bs-target="#editModuleModal--{{ $item->id }}"
                                                            >
                                                    ...
                                                    @if ($remover)
                                                        ...
                                                        <li>
                                                            <a 
                                                                href="#" 
                                                                data-url="{{ route('admin.module.destroy', ['id' => $item->id]) }}" 
                                    ...
                                    @if ($editar)
                                        <div class="modal fade" id="editModuleModal--{{ $item->id }}" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Editar Module</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form 
                                                            method="post" 
                                                            action="{{ route('admin.module.update', ['id' => $item->id]) }}" 
                                                            class="row g-3" 
                                    ...
                                    <tr>
                                        <td colspan="9" class="text-center py-5">
                                            <div class="d-flex flex-column align-items-center">
                                                ...
                                                <p class="text-muted mb-0">Não há module cadastrados no momento.</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
        ...
        @if ($adicionar)
            <div class="modal fade" id="addModuleModal" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Adicionar Novo Module</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
