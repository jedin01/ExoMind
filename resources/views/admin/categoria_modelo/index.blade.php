...
@section('titulo', 'Categorias de Modelo')
...
@section('conteudo')
    <!-- Categorias de Modelo Table -->
    <div class="card">
        <div class="card-datatable table-responsive">
            <div class="d-flex justify-content-between p-4 align-items-center mb-3">
                <h4 class="mb-0">Gerenciamento de Categorias de Modelo</h4>
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addModal">
                    <i class="bx bx-plus me-1"></i>
                </button>
                <a class="btn btn-primary" href="{{ route('admin.categoria_modelo.trashed') }}">
                    <i class="bx bx-trash me-1"></i>
                </a>
            </div>
            <table class="datatables-categoria_modelo table">
                ...
                <tbody>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <li>
                                            <a href="{{ route('admin.categoria_modelo.show', ['id' => $item->id]) }}" class="dropdown-item">
                                                <i class="bx bx-show me-1"></i> Ver Detalhes
                                            </a>
                                        </li>

                                        <li>
                                            <a href="{{ route('admin.categoria_modelo.hiperparametro_categoria_modelo', ['id' => $item->id]) }}" class="dropdown-item">
                                                <i class="bx bx-show me-1"></i> Hiperparametrocategoriamodelos
                                            </a>
                                        </li>

                                        <li>
                                            <a href="{{ route('admin.categoria_modelo.modelo', ['id' => $item->id]) }}" class="dropdown-item">
                                                <i class="bx bx-show me-1"></i> Modelos
                                            </a>
                                        </li>

                                        <li>
                                            <a href="#" data-url="{{ route('admin.categoria_modelo.destroy', ['id' => $item->id]) }}" class="removeItem dropdown-item">
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered modal-simple">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            ...
                                            <form class="row" method="post" action="{{ route('admin.categoria_modelo.update', ['id' => $item->id]) }}" class="row" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row">
                                                    @include('forms.categoria_modelo.index')
                                                </div>
                    ...
                    @empty
                        <tr>
                            ...
                            <td colspan="3" class="text-center">Nenhum categoria_modelo encontrado.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-simple">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <form class="row" action="{{ route('admin.categoria_modelo.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @php
                            $item = null;
                        @endphp
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            @if(count($items) != 0)
                $('.datatables-categoria_modelo').DataTable({
                    responsive: true,
                    order: [[0, 'asc']],
                    language: {
