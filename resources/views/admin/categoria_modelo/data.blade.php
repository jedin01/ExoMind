<div class="container-fluid">
                ...
                <div class="card ">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h4 class="mb-1">Categorias de Modelo</h4>
                                <p class="mb-0 opacity-75">Gerencie todos os registros de categoriamodelo</p>
                            </div>
                            ...
                            @if ($adicionar)
                                <button 
                                    ...
                                    data-bs-target="#addCategoriaModeloModal"
                                >
                                    <i class="bx bx-plus me-1"></i>
                                    Adicionar CategoriaModelo
                                </button>
                            @endif
                        </div>
                    </div>
                          ...
                          <thead class="border-top">
                            ...
                            <tbody>
                                @forelse($items as $item)
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a 
                                                            href="{{ route('admin.categoria_modelo.show', ['id' => $item->id]) }}" 
                                                            class="dropdown-item"
                                                        >
                                                    ...
                                                    @if ($editar)
                                                        <li>
                                                            <a 
                                                                ...
                                                                class="dropdown-item" 
                                                                data-bs-toggle="modal" 
                                                                data-bs-target="#editCategoriaModeloModal--{{ $item->id }}"
                                                            >
                                                    ...
                                                    @if ($remover)
                                                        ...
                                                        <li>
                                                            <a 
                                                                href="#" 
                                                                data-url="{{ route('admin.categoria_modelo.destroy', ['id' => $item->id]) }}" 
                                    ...
                                    @if ($editar)
                                        <div class="modal fade" id="editCategoriaModeloModal--{{ $item->id }}" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Editar CategoriaModelo</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form 
                                                            method="post" 
                                                            action="{{ route('admin.categoria_modelo.update', ['id' => $item->id]) }}" 
                                                            class="row g-3" 
                                    ...
                                    <tr>
                                        <td colspan="3" class="text-center py-5">
                                            <div class="d-flex flex-column align-items-center">
                                                ...
                                                <p class="text-muted mb-0">Não há categoriamodelo cadastrados no momento.</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
        ...
        <!-- Modal de Adição -->
        @if ($adicionar)
            <div class="modal fade" id="addCategoriaModeloModal" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Adicionar Novo CategoriaModelo</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        ...
                        <div class="modal-body">
                            <form 
                                class="row g-3" 
                                action="{{ route('admin.categoria_modelo.store') }}" 
                                method="post" 
                                enctype="multipart/form-data"
                            >
                                @csrf
