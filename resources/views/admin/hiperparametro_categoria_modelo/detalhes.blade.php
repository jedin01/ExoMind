...
@section('titulo', 'Detalhes do HiperparametroCategoriaModelo')
...
<div class="row">
    ...
    <div class="col-xl-8 col-lg-7 order-0 order-md-1">
      <!-- User Pills -->
      @php
        $hiperparametro_categoria_modelo_detail = $item;
      @endphp
...
<!-- Edit  Modal -->
@php
  $item = $hiperparametro_categoria_modelo_detail;
@endphp
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered modal-simple">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <form method="post" enctype="multipart/form-data" action="{{route('admin.hiperparametro_categoria_modelo.update',['id' => $item->id])}}" class="row">
          @csrf
