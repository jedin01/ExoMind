...
@section('titulo', 'Detalhes do Metricas')
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered modal-simple">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <form method="post" enctype="multipart/form-data" action="{{route('admin.metrica.update',['id' => $item->id])}}" class="row">
          @csrf
