                ...
                <div class="card ">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h4 class="mb-1">Treinamento de Metricas</h4>
                                <p class="mb-0 opacity-75">Gerencie todos os registros de treinamentometrica</p>
                            </div>
                            ...
                            @if ($adicionar)
                                <button 
                                    ...
                                    data-bs-target="#addTreinamentoMetricaModal"
                                >
                                    <i class="bx bx-plus me-1"></i>
                                    Adicionar TreinamentoMetrica
                                </button>
                            @endif
                        </div>
                    </div>
                ...
                <div class="card shadow-sm">
                    <div class="card-header border-bottom">
                        <h5 class="card-title mb-0">
                            ...
                            Lista de Treinamento de Metricas
                        </h5>
                    </div>
                    
                    <div class="card-datatable table-responsive">
                        <table class="datatables-treinamento_metrica table">
...
{{ $item->fk_metricas->nome ?? 'N/A' }}                                                </span>
                                            </td>
                                            <td>
                                                <span class="text-primary fw-medium">
{{ $item->fk_treinamento->nome ?? 'N/A' }}                                                </span>
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a 
                                                            href="{{ route('admin.treinamento_metrica.show', ['id' => $item->id]) }}" 
                                                            class="dropdown-item"
                                                        >
                                                    ...
                                                    @if ($editar)
                                                        <li>
                                                            <a 
                                                                ...
                                                                class="dropdown-item" 
                                                                data-bs-toggle="modal" 
                                                                data-bs-target="#editTreinamentoMetricaModal--{{ $item->id }}"
                                                            >
                                                    ...
                                                    @if ($remover)
                                                        ...
                                                        <li>
                                                            <a 
                                                                href="#" 
                                                                data-url="{{ route('admin.treinamento_metrica.destroy', ['id' => $item->id]) }}" 
                                    ...
                                    @if ($editar)
                                        <div class="modal fade" id="editTreinamentoMetricaModal--{{ $item->id }}" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Editar TreinamentoMetrica</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form 
                                                            method="post" 
                                                            action="{{ route('admin.treinamento_metrica.update', ['id' => $item->id]) }}" 
                                                            class="row g-3" 
                                                        ...
                                                        >
                                                            ...
                                                            @include('forms.treinamento_metrica.index')
                                    ...
                                    <tr>
                                        <td colspan="4" class="text-center py-5">
                                            <div class="d-flex flex-column align-items-center">
                                                ...
                                                <p class="text-muted mb-0">Não há treinamentometrica cadastrados no momento.</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
        ...
        <!-- Modal de Adição -->
        @if ($adicionar)
            <div class="modal fade" id="addTreinamentoMetricaModal" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Adicionar Novo TreinamentoMetrica</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        ...
                        <div class="modal-body">
                            <form 
                                class="row g-3" 
                                action="{{ route('admin.treinamento_metrica.store') }}" 
                                method="post" 
                                enctype="multipart/form-data"
                            >
                                @csrf
