                ...
                <div class="card ">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h4 class="mb-1">Hiperparametros de Modelo</h4>
                                <p class="mb-0 opacity-75">Gerencie todos os registros de hiperparametromodelo</p>
                            </div>
                            ...
                            @if ($adicionar)
                                <button 
                                    ...
                                    data-bs-target="#addHiperparametroModeloModal"
                                >
                                    <i class="bx bx-plus me-1"></i>
                                    Adicionar HiperparametroModelo
                                </button>
                            @endif
                        </div>
                    </div>
                ...
                <div class="card shadow-sm">
                    <div class="card-header border-bottom">
                        <h5 class="card-title mb-0">
                            ...
                            Lista de Hiperparametros de Modelo
                        </h5>
                    </div>
                    
                    <div class="card-datatable table-responsive">
                        <table class="datatables-hiperparametro_modelo table">
...
{{ $item->fk_modelo->nome ?? 'N/A' }}                                                </span>
                                            </td>
                                            <td>
                                                <span class="text-primary fw-medium">
{{ $item->fk_hiperparametro_categoria_modelo->nome ?? 'N/A' }}                                                </span>
                                            </td>
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a 
                                                            href="{{ route('admin.hiperparametro_modelo.show', ['id' => $item->id]) }}" 
                                                            class="dropdown-item"
                                                        >
                                                    ...
                                                    @if ($editar)
                                                        <li>
                                                            <a 
                                                                ...
                                                                class="dropdown-item" 
                                                                data-bs-toggle="modal" 
                                                                data-bs-target="#editHiperparametroModeloModal--{{ $item->id }}"
                                                            >
                                                    ...
                                                    @if ($remover)
                                                        ...
                                                        <li>
                                                            <a 
                                                                href="#" 
                                                                data-url="{{ route('admin.hiperparametro_modelo.destroy', ['id' => $item->id]) }}" 
                                    ...
                                    @if ($editar)
                                        <div class="modal fade" id="editHiperparametroModeloModal--{{ $item->id }}" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Editar HiperparametroModelo</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form 
                                                            method="post" 
                                                            action="{{ route('admin.hiperparametro_modelo.update', ['id' => $item->id]) }}" 
                                                            class="row g-3" 
                                                        ...
                                                        >
                                                            ...
                                                            @include('forms.hiperparametro_modelo.index')
                                    ...
                                    <tr>
                                        <td colspan="5" class="text-center py-5">
                                            <div class="d-flex flex-column align-items-center">
                                                ...
                                                <p class="text-muted mb-0">Não há hiperparametromodelo cadastrados no momento.</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
        ...
        <!-- Modal de Adição -->
        @if ($adicionar)
            <div class="modal fade" id="addHiperparametroModeloModal" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Adicionar Novo HiperparametroModelo</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        ...
                        <div class="modal-body">
                            <form 
                                class="row g-3" 
                                action="{{ route('admin.hiperparametro_modelo.store') }}" 
                                method="post" 
                                enctype="multipart/form-data"
                            >
                                @csrf
