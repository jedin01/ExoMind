...
@section('titulo', 'Detalhes do Role')
        ...
        <div class="card-body pt-12">
          ...
          <div class="info-container">
            <ul class="list-unstyled mb-6">
              <li class="mb-2">
                <span class="h6">Descricao: </span>
                <span>{{ $item->lt_descricao }}</span>
              </li>
            </ul>
    ...
    <div class="col-xl-8 col-lg-7 order-0 order-md-1">
      ...
      <div class="bs-stepper wizard-numbered mt-2">
        ...
        <div class="bs-stepper-content">
          ...
          <div class="card mb-6 content" id="user">
            @include('admin.user.data',[
              'items' => $item->fk_user,
              'role_detail' => $item,
              'title' => "Gestão de User",
              'subtitle' => "User",
              'relation_name' => "user",
              'adicionar' => true,
              'editar' => true,
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered modal-simple">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <form method="post" enctype="multipart/form-data" action="{{route('admin.role.update',['id' => $item->id])}}" class="row">
          @csrf
