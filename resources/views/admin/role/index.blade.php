    ...
    <div class="card">
        <div class="card-datatable table-responsive">
            <div class="d-flex justify-content-between p-4 align-items-center mb-3">
                <h4 class="mb-0">Gerenciamento de Roles</h4>
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addModal">
                    <i class="bx bx-plus me-1"></i>
                </button>
                <a class="btn btn-primary" href="{{ route('admin.role.trashed') }}">
                ...
                <tbody>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <li>
                                            <a href="{{ route('admin.role.show', ['id' => $item->id]) }}" class="dropdown-item">
                                                <i class="bx bx-show me-1"></i> Ver Detalhes
                                            </a>
                                        </li>

                                        <li>
                                            <a href="{{ route('admin.role.role_permissions', ['id' => $item->id]) }}" class="dropdown-item">
                                                <i class="bx bx-show me-1"></i> Rolepermissionss
                                            </a>
                                        </li>

                                        <li>
                                            <a href="{{ route('admin.role.user', ['id' => $item->id]) }}" class="dropdown-item">
                                                <i class="bx bx-show me-1"></i> Users
                                            </a>
                                        </li>

                                        <li>
                                            <a href="#" data-url="{{ route('admin.role.destroy', ['id' => $item->id]) }}" class="removeItem dropdown-item">
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered modal-simple">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            ...
                                            <form class="row" method="post" action="{{ route('admin.role.update', ['id' => $item->id]) }}" class="row" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row">
                                                    @include('forms.role.index')
                                                </div>
                    ...
                    @empty
                        <tr>
                            ...
                            <td colspan="4" class="text-center">Nenhum role encontrado.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
