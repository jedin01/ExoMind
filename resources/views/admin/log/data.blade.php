                ...
                <div class="card ">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h4 class="mb-1">Logs</h4>
                                <p class="mb-0 opacity-75">Gerencie todos os registros de log</p>
                            </div>
            ...
            <div class="col-12">
                <div class="card shadow-sm">
                    ...
                    <div class="card-datatable table-responsive">
                        <table class="datatables-log table">
...
{{ Str::limit($item->lt_description, 50) }}                                                    </span>
                                            </td>
                                            <td>
                                                    <span class="fw-medium">{{ $item->vc_agent }}</span>
                                            </td>
                                            <td>
                                                    <span class="fw-medium">{{ $item->vc_ip_address }}</span>
                                            </td>
                                            <td>
                                                    <span class="fw-medium">{{ $item->vc_level }}</span>
                                            </td>
                                        
                                            <td>
                                                <span class="text-primary fw-medium">
{{ $item->fk_user->nome ?? 'N/A' }}                                                </span>
                                            </td>
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a 
                                                            href="{{ route('admin.log.show', ['id' => $item->id]) }}" 
                                                            class="dropdown-item"
                                                        >
                                                    ...
                                                    @if ($editar)
                                                        <li>
                                                            <a 
                                                                ...
                                                                class="dropdown-item" 
                                                                data-bs-toggle="modal" 
                                                                data-bs-target="#editLogModal--{{ $item->id }}"
                                                            >
                                                    ...
                                                    @if ($remover)
                                                        ...
                                                        <li>
                                                            <a 
                                                                href="#" 
                                                                data-url="{{ route('admin.log.destroy', ['id' => $item->id]) }}" 
                                    ...
                                    @if ($editar)
                                        <div class="modal fade" id="editLogModal--{{ $item->id }}" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form 
                                                            method="post" 
                                                            action="{{ route('admin.log.update', ['id' => $item->id]) }}" 
                                                            class="row g-3" 
                                    ...
                                    <tr>
                                        <td colspan="7" class="text-center py-5">
                                            <div class="d-flex flex-column align-items-center">
                                                ...
                                                <p class="text-muted mb-0">Não há log cadastrados no momento.</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
        ...
        @if ($adicionar)
            <div class="modal fade" id="addLogModal" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Adicionar Novo Log</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
