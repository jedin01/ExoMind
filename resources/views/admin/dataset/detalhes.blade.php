...
@section('titulo', 'Detalhes do Dataset')
        ...
        <div class="card-body pt-12">
          ...
          <div class="info-container">
            <ul class="list-unstyled mb-6">
              <li class="mb-2">
                <span class="h6">Caminho: </span>
                <span>{{ $item->caminho }}</span>
              </li>
              <li class="mb-2">
                <span class="h6">Qtd_observacoes: </span>
                <span>{{ $item->qtd_observacoes }}</span>
              </li>
              <li class="mb-2">
                <span class="h6">Fonte:</span>
                <span>{{ isset($item->fk_fonte) ? $item->fk_fonte->nome_registro : '' }}</span>
              </li>
            </ul>
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered modal-simple">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <form method="post" enctype="multipart/form-data" action="{{route('admin.dataset.update',['id' => $item->id])}}" class="row">
          @csrf
