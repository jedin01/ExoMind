...
<!-- header start -->
					...
					<div class="collapse navbar-collapse main-menu">
                        <div class="nav-menu-wrapper">
                            <ul class="navbar-nav mr-auto" id="menu">
                                ...
                                <li class="nav-item submenu"><a class="nav-link" href="#">Pages</a>
                                    <ul>                                        
                                        <li class="nav-item"><a class="nav-link" href="{{ url('/services') }}">Service Details</a></li>
                                        <li class="nav-item"><a class="nav-link" href="{{ url('/blog') }}">Blog Details</a></li>
                                        <li class="nav-item"><a class="nav-link" href="{{ url('/team') }}">Our Team</a></li>
                                        <li class="nav-item"><a class="nav-link" href="{{ url('/team') }}">Team Details</a></li>
                                        ...
                                        <li class="nav-item"><a class="nav-link" href="{{ url('/gallery/images') }}">Image Gallery</a></li>
                                        <li class="nav-item"><a class="nav-link" href="{{ url('/gallery/videos') }}">Video Gallery</a></li>
    ...
    <div class="hero parallaxie">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="hero-content">
                        ...
                        <div class="hero-body wow fadeInUp" data-wow-delay="0.4s">
                            <!-- Hero Button Start -->
                            <div class="hero-btn">
                                <a href="{{ url('/book-appointment') }}" class="btn-default">join us today</a>                                
                            </div>
                            <!-- Hero Button End -->
        ...
        <div class="down-arrow-circle">
            <a href="#home-about"><img src="{{ asset('/assets/img/down-circle.svg') }}" alt=""><i class="fa-solid fa-arrow-down"></i></a>
        </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="about-images">
                        ...
                        <div class="about-image">
                            <figure>
                                <img src="{{ asset('/assets/img/about-us-img.png') }}" alt="">
                            </figure>
                        </div>
                        <!-- About Image End -->
                    ...
                    <div class="about-us-content">
                        ...
                        <div class="about-content-body">
                            ...
                            <div class="about-benefit-item wow fadeInUp" data-wow-delay="0.4s">
                                <div class="icon-box">
                                    <img src="{{ asset('/assets/img/icon-about-benefit-1.svg') }}" alt="">
                                </div>
                            ...
                            <div class="about-benefit-item wow fadeInUp" data-wow-delay="0.6s">
                                <div class="icon-box">
                                    <img src="{{ asset('/assets/img/icon-about-benefit-2.svg') }}" alt="">
                                </div>
                                <div class="about-benefit-item-content">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp">
                        ...
                        <div class="service-header">
                            <div class="icon-box">
                                <img src="{{ asset('/assets/img/icon-service-item-1.svg') }}" alt="">
                            </div>
                            <div class="service-btn">
                                <a href="{{ url('/services') }}"><img src="{{ asset('/assets/img/arrow-white.svg') }}" alt=""></a>
                            </div>
                        </div>
                        <!-- Service Header End -->
                        ...
                        <div class="service-content">
                            <h3><a href="{{ url('/services') }}">Beginner Yoga Classes</a></h3>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="service-header">
                            <div class="icon-box">
                                <img src="{{ asset('/assets/img/icon-service-item-2.svg') }}" alt="">
                            </div>
                            <div class="service-btn">
                                <a href="{{ url('/services') }}"><img src="{{ asset('/assets/img/arrow-white.svg') }}" alt=""></a>
                            </div>
                        ...
                        <!-- Service Content Start -->
                        <div class="service-content">
                            <h3><a href="{{ url('/services') }}">Stress Relief Sessions</a></h3>
                            <p>Learn foundational poses and techniques yoga journey.</p>
                        </div>
                        <!-- Service Content End -->
                    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <div class="service-header">
                            <div class="icon-box">
                                <img src="{{ asset('/assets/img/icon-service-item-3.svg') }}" alt="">
                            </div>
                            <div class="service-btn">
                                <a href="{{ url('/services') }}"><img src="{{ asset('/assets/img/arrow-white.svg') }}" alt=""></a>
                            </div>
                        ...
                        <!-- Service Content Start -->
                        <div class="service-content">
                            <h3><a href="{{ url('/services') }}">Mindful Meditation</a></h3>
                            <p>Learn foundational poses and techniques yoga journey.</p>
                        </div>
                        <!-- Service Content End -->
                    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.6s">
                        ...
                        <div class="service-header">
                            <div class="icon-box">
                                <img src="{{ asset('/assets/img/icon-service-item-4.svg') }}" alt="">
                            </div>
                            <div class="service-btn">
                                <a href="{{ url('/services') }}"><img src="{{ asset('/assets/img/arrow-white.svg') }}" alt=""></a>
                            </div>
                        ...
                        <!-- Service Content Start -->
                        <div class="service-content">
                            <h3><a href="{{ url('/services') }}">Mental Clarity Meditation</a></h3>
                            <p>Learn foundational poses and techniques yoga journey.</p>
                        </div>
                        <!-- Service Content End -->
                    </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="section-footer-text wow fadeInUp" data-wow-delay="0.2s">
                        <p><span>Free</span>Let's make something great work together. <a href="{{ url('/contact') }}">Get Free Quote</a></p>
                    </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 order-lg-1 order-2">
                    ...
                    <div class="what-we-image">
                        <figure>
                            <img src="{{ asset('/assets/img/what-we-image.png') }}" alt="">
                        </figure>
                    </div>
                    <!-- What We Image End -->
                </div>
                    ...
                    <div class="what-we-benefits-box">
                        ...
                        <div class="what-we-benefits-list">
                            ...
                            <div class="what-we-item wow fadeInUp">
                                <div class="icon-box">
                                    <img src="{{ asset('/assets/img/icon-what-we-item-1.svg') }}" alt="">
                                </div>
                            ...
                            <div class="what-we-item wow fadeInUp" data-wow-delay="0.2s">
                                <div class="icon-box">
                                    <img src="{{ asset('/assets/img/icon-what-we-item-2.svg') }}" alt="">
                                </div>
                                <div class="what-we-item-content">
                            ...
                            <div class="what-we-item wow fadeInUp" data-wow-delay="0.4s">
                                <div class="icon-box">
                                    <img src="{{ asset('/assets/img/icon-what-we-item-3.svg') }}" alt="">
                                </div>
                                <div class="what-we-item-content">
                            ...
                            <div class="what-we-item wow fadeInUp" data-wow-delay="0.6s">
                                <div class="icon-box">
                                    <img src="{{ asset('/assets/img/icon-what-we-item-4.svg') }}" alt="">
                                </div>
                                <div class="what-we-item-content">
                        ...
                        <div class="what-we-benefit-image">
                            <figure class="image-anime">
                                <img src="{{ asset('/assets/img/what-we-benefit-image.jpg') }}" alt="">
                            </figure>
                        </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="why-choose-content">
                        ...
                        <div class="why-choose-image">
                            <figure class="image-anime reveal">
                                <img src="{{ asset('/assets/img/why-choose-image.jpg') }}" alt="">
                            </figure>
                        </div>
                        ...
                        <div class="why-choose-item wow fadeInUp">
                            <div class="icon-box">
                                <img src="{{ asset('/assets/img/icon-why-choose-item-1.svg') }}" alt="">
                            </div>
                        ...
                        <div class="why-choose-item wow fadeInUp" data-wow-delay="0.2s">
                            <div class="icon-box">
                                <img src="{{ asset('/assets/img/icon-why-choose-item-2.svg') }}" alt="">
                            </div>
                            <div class="why-choose-item-content">
                    ...
                    <div class="why-choose-counter-box">
                        ...
                        <div class="why-choose-counter-item">
                            <div class="icon-box">
                                <img src="{{ asset('/assets/img/icon-why-choose-counter-1.svg') }}" alt="">
                            </div>
                        ...
                        <div class="why-choose-counter-item">
                            <div class="icon-box">
                                <img src="{{ asset('/assets/img/icon-why-choose-counter-2.svg') }}" alt="">
                            </div>
                            <div class="why-choose-counter-content">
                        ...
                        <div class="why-choose-counter-item">
                            <div class="icon-box">
                                <img src="{{ asset('/assets/img/icon-why-choose-counter-3.svg') }}" alt="">
                            </div>
                            <div class="why-choose-counter-content">
                        ...
                        <div class="why-choose-counter-item">
                            <div class="icon-box">
                                <img src="{{ asset('/assets/img/icon-why-choose-counter-4.svg') }}" alt="">
                            </div>
                            <div class="why-choose-counter-content">
            ...
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-6 order-1">
                    ...
                    <div class="our-benefits-box">
                        ...
                        <div class="benefit-item wow fadeInUp" data-wow-delay="0.4s">
                            <div class="icon-box">
                                <img src="{{ asset('/assets/img/icon-benefit-item-1.svg') }}" alt="">
                            </div>
                        ...
                        <div class="benefit-item wow fadeInUp" data-wow-delay="0.6s">
                            <div class="icon-box">
                                <img src="{{ asset('/assets/img/icon-benefit-item-2.svg') }}" alt="">
                            </div>
                            <div class="benefit-item-content">
                ...
                <div class="col-lg-6 order-lg-2 order-md-3 order-2">
                    ...
                    <div class="our-benefits-image">
                        <figure>
                            <img src="{{ asset('/assets/img/benefits-image.png') }}" alt="">
                        </figure>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 order-lg-3 order-md-2 order-3">
                    ...
                    <div class="our-benefits-box">
                        ...
                        <div class="benefit-item wow fadeInUp" data-wow-delay="0.4s">
                            <div class="icon-box">
                                <img src="{{ asset('/assets/img/icon-benefit-item-3.svg') }}" alt="">
                            </div>
                            <div class="benefit-item-content">
                        ...
                        <div class="benefit-item wow fadeInUp" data-wow-delay="0.6s">
                            <div class="icon-box">
                                <img src="{{ asset('/assets/img/icon-benefit-item-4.svg') }}" alt="">
                            </div>
                            <div class="benefit-item-content">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="intro-video-box">
                        <div class="intro-bg-video">
                            ...
                            <!-- <video autoplay muted loop id="introVideo"><source src="{{ asset('/assets/img/restraint-video.mp4') }}" type="video/mp4"></video> -->
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-3">
                    ...
                    <div class="section-btn wow fadeInUp">
                        <a href="{{ url('/contact') }}" class="btn-default btn-highlighted">read more</a>
                    </div>
                    <!-- Section Button End -->
                </div>
            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="how-work-image">
                        <figure>
                            <img src="{{ asset('/assets/img/how-work-image.png') }}" alt="">
                        </figure>
                    </div>
                    <!-- How Work Image End -->
                </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="features-item wow fadeInUp">
                        ...
                        <div class="features-item-image">
                            <figure>
                                <img src="{{ asset('/assets/img/features-image-1.png') }}" alt="">
                            </figure>
                        </div>
                    </div>
                    <!-- Features Item End -->
                    ...
                    <div class="our-features-boxes">
                        ...
                        <div class="features-box box-1 wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <div class="features-box-image">
                                <figure>
                                    <img src="{{ asset('/assets/img/features-image-2.jpg') }}" alt="">
                                </figure>
                            </div>
                        </div>
                        <!-- Features Box End -->
                        ...
                        <div class="features-box box-2 wow fadeInUp" data-wow-delay="0.4s">
                            ...
                            <div class="features-box-image">
                                <figure>
                                    <img src="{{ asset('/assets/img/features-image-3.jpg') }}" alt="">
                                </figure>
                            </div>
                        </div>
                        <!-- Features Box End -->
                        ...
                        <div class="features-item features-box box-3 wow fadeInUp" data-wow-delay="0.6s">
                            ...
                            <div class="features-item-image">
                                <figure>
                                    <img src="{{ asset('/assets/img/features-image-4.png') }}" alt="">
                                </figure>
                            </div>
                        </div>
                        <!-- Features Item End -->
            ...
            <div class="row align-items-center">
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="pricing-item wow fadeInUp">
                        ...
                        <div class="pricing-image">
                            <figure class="image-anime">
                                <img src="{{ asset('/assets/img/pricing-image-1.jpg') }}" alt="">
                            </figure>
                        </div>
                        <!-- Pricing Image End -->
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="pricing-item highlighted-box wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="pricing-image">
                            <figure class="image-anime">
                                <img src="{{ asset('/assets/img/pricing-image-2.jpg') }}" alt="">
                            </figure>
                        </div>
                        <!-- Pricing Image End -->
                        ...
                        <div class="pricing-body">
                            ...
                            <!-- Pricing Button Start -->
                            <div class="pricing-btn">
                                <a href="{{ url('/contact') }}" class="btn-default btn-highlighted">get started now</a>
                            </div>
                            <!-- Pricing Button End -->
                        </div>
                        <!-- Pricing Body End -->
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="pricing-item wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <div class="pricing-image">
                            <figure class="image-anime">
                                <img src="{{ asset('/assets/img/pricing-image-3.jpg') }}" alt="">
                            </figure>
                        </div>
                        <!-- Pricing Image End -->
    ...
    <div class="scrolling-ticker">
        ...
        <div class="scrolling-ticker-box">
            ...
            <div class="scrolling-content">
                <span><img src="{{ asset('/assets/img/icon-asterisk.svg') }}" alt="">Serene Flow</span>
                <span><img src="{{ asset('/assets/img/icon-asterisk.svg') }}" alt="">Mindful Movement</span>
                <span><img src="{{ asset('/assets/img/icon-asterisk.svg') }}" alt="">Yoga Journey</span>
                <span><img src="{{ asset('/assets/img/icon-asterisk.svg') }}" alt="">Flex & Relax</span>
                <span><img src="{{ asset('/assets/img/icon-asterisk.svg') }}" alt="">Calm & Balance</span>
                <span><img src="{{ asset('/assets/img/icon-asterisk.svg') }}" alt="">Serene Flow</span>
                <span><img src="{{ asset('/assets/img/icon-asterisk.svg') }}" alt="">Mindful Movement</span>
                <span><img src="{{ asset('/assets/img/icon-asterisk.svg') }}" alt="">Yoga Journey</span>
                <span><img src="{{ asset('/assets/img/icon-asterisk.svg') }}" alt="">Flex & Relax</span>
            ...
            <div class="scrolling-ticker-images">
                ...
                <div class="scrolling-ticker-image">
                    <figure class="image-anime">
                        <img src="{{ asset('/assets/img/scrolling-ticker-image-1.jpg') }}" alt="">
                    </figure>
                </div>
                ...
                <div class="scrolling-ticker-image">
                    <figure class="image-anime">
                        <img src="{{ asset('/assets/img/scrolling-ticker-image-2.jpg') }}" alt="">
                    </figure>
                </div>
                <!-- Scrolling Ticker Image End -->
                ...
                <div class="scrolling-ticker-image">
                    <figure class="image-anime">
                        <img src="{{ asset('/assets/img/scrolling-ticker-image-3.jpg') }}" alt="">
                    </figure>
                </div>
                <!-- Scrolling Ticker Image End -->
                ...
                <div class="scrolling-ticker-image">
                    <figure class="image-anime">
                        <img src="{{ asset('/assets/img/scrolling-ticker-image-4.jpg') }}" alt="">
                    </figure>
                </div>
                <!-- Scrolling Ticker Image End -->
                ...
                <div class="scrolling-ticker-image">
                    <figure class="image-anime">
                        <img src="{{ asset('/assets/img/scrolling-ticker-image-5.jpg') }}" alt="">
                    </figure>
                </div>
                <!-- Scrolling Ticker Image End -->
            </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="testimonial-image-content">
                        ...
                        <div class="testimonial-image">
                            <figure class="image-anime reveal">
                                <img src="{{ asset('/assets/img/testimonial-image.jpg') }}" alt="">
                            </figure>
                        </div>
                        ...
                        <div class="testimonial-review-box wow fadeInUp">
                            ...
                            <div class="testimonial-review-body">
                                ...
                                <div class="testimonial-review-btn">
                                    <a href="{{ url('/contact') }}"><img src="{{ asset('/assets/img/arrow-white.svg') }}" alt=""></a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row section-row align-items-center">
                ...
                <div class="col-lg-6">
                    <!-- Section Button Start -->
                    <div class="section-btn wow fadeInUp" data-wow-delay="0.2s">
                        <a href="{{ url('/faqs') }}" class="btn-default">view all faqs</a>
                    </div>
                    <!-- Section Button End -->
                </div>
            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="faqs-image">
                        <figure class="image-anime reveal">
                            <img src="{{ asset('/assets/img/faqs-image.jpg') }}" alt="">
                        </figure>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="post-item wow fadeInUp">
                        ...
                        <div class="post-featured-image">
                            <a href="{{ url('/blog') }}" data-cursor-text="View">
                                <figure class="image-anime">
                        ...
                        <div class="post-item-body">
                            ...
                            <div class="post-item-content">
                                <h2><a href="{{ url('/blog') }}">Chakra Balancing Through Yoga and Meditation</a></h2>
                            </div>
                            <!-- Post Item Content End -->

                            <!-- Post Item Readmore Button Start-->
                            <div class="post-item-btn">
                                <a href="{{ url('/blog') }}" class="readmore-btn">read more</a>
                            </div>
                    ...
                    <div class="post-item wow fadeInUp" data-wow-delay="0.2s">
                       ...
                       <div class="post-featured-image">
                        ...
                        <div class="post-item-body">
                            <!-- Post Item Content Start -->
                            <div class="post-item-content">
                                <h2><a href="{{ url('/blog') }}">The Science Behind Mindfulness Practices</a></h2>
                            </div>
                            <!-- Post Item Content End -->
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="post-item wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <div class="post-item-body">
                            <!-- Post Item Content Start -->
                            <div class="post-item-content">
                                <h2><a href="{{ url('/blog') }}">Creating a Peaceful Meditation Space at Home</a></h2>
                            </div>
                            <!-- Post Item Content End -->
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-4">
                    ...
                    <div class="footer-links">
                        <h3>services</h3>
                        <ul>
                            <li><a href="{{ url('/services') }}">Beginner yoga classes</a></li>
                            <li><a href="{{ url('/services') }}">Stress relief sessions</a></li>
                            <li><a href="{{ url('/services') }}">Mindful meditation</a></li>
                            <li><a href="{{ url('/services') }}"> Restorative Yoga</a></li>
                        </ul>
                    </div>
                    <!-- Footer Links End -->
                </div>
